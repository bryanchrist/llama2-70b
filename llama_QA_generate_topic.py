...
for i in range(0,100):
    ...
    final_prompt = "Write a grade school math word problem about Superman and Python program to solve the word problem."
    questions = []
    for i in range(0, 7):
    ...
    output_file = "llama_QA_generate_topic.txt"  # Specify the path and filename for the output file
