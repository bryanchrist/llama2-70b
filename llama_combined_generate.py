...
adapter_path = "llama_combined_adapter/checkpoint-2000"  # Specify the path to the adapter weights
...
for i in range(0,2000):
    ...
    output_file = "llama_combined_generate_grades_v2.txt"  # Specify the path and filename for the output file
