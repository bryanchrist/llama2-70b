...
adapter_path = "mathwell/llama3-8b-full_data/checkpoint-7000"  # Specify the path to the adapter weights
...
for i in range(0,1000):
    ...
    output_file = "mathwell8b_full_questions.txt"  # Specify the path and filename for the output file
