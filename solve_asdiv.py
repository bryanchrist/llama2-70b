...
for i in range(0,len(df)):
    ...
    output_file = "mammoth_solve_asdiv.txt"  # Specify the path and filename for the output file
    with open(output_file, "a") as f:  # Open the file in append mode ("a")
        f.write(f"Question {df.iloc[i]['question_number']} solution:" + newly_generated_text + "\n")  # Append the newly generated text to the file
